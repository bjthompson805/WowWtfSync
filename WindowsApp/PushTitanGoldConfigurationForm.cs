...
{
    public class PushTitanGoldConfigurationForm : PushConfigurationForm
    {
        public PushTitanGoldConfigurationForm() { }
        public PushTitanGoldConfigurationForm(
        ...
        protected override string GetDescription()
        {
            ...
            if (this.pushAllCharacters)
            {
                description = "Push TitanGold data from each character " +
                    "to all accounts that are not the same as the character's account.";
            }
            else
            {
                description = $"Push TitanGold data from {this.characterName}-" +
                    $"{this.realm}-{this.account} to all accounts that are not the " +
                    "same as the character's account.";

            }

            description += " This will allow you to view characters' gold " +
